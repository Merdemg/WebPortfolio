    ...
    <section class="section section-lg bg-gray-100 text-center">
        <div class="container">
            <div class="row row-30 row-xl-70 justify-content-center">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=3">
                            <img src="images/portfolio-03-370x280.jpg" alt="" width="370" height="280" /></a></div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=4">
                            <img src="images/portfolio-04-370x280.jpg" alt="" width="370" height="280" /></a></div>
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=1">
                            <img src="images/portfolio-01-370x280.jpg" alt="" width="370" height="280" /></a></div>
                        <a class="portfolio-title" href="Project.aspx?id=1">Exorcism at Dusckridge Manor</a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=2">
                            <img src="images/portfolio-02-370x280.jpg" alt="" width="370" height="280" /></a></div>
              ...
              <div class="portfolio">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=5">
                            <img src="images/portfolio-05-370x280.jpg" alt="" width="370" height="280" /></a></div>
                        <a class="portfolio-title" href="Project.aspx?id=5">Uppskera</a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=6">
                            <img src="images/portfolio-06-370x280.jpg" alt="" width="370" height="280" /></a></div>
                        <a class="portfolio-title" href="Project.aspx?id=6">Bringer of Peace</a>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-4">
                    <div class="portfolio">
                        <div class="portfolio-img"><a href="Project.aspx?id=7">
                            <img src="images/portfolio-07-370x280.jpg" alt="" width="370" height="280" /></a></div>
